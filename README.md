# ![Real World Halogen](./assets/logo.png)
...
> [Purescript](https://www.purescript.org/) + [Halogen](https://purescript-halogen.github.io/purescript-halogen/) codebase containing real world examples (CRUD, auth, advanced patterns, etc) that adheres to the [RealWorld](https://github.com/gothinkster/realworld-example-apps) spec and API.


[Demo](https://thomashoneyman.github.io/purescript-halogen-realworld)&nbsp;&nbsp;&nbsp;&nbsp;[RealWorld](https://github.com/gothinkster/realworld)
